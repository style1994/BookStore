...
public class ProductSearchView extends JPanel
{
    ...
    public ProductSearchView(JTable table, String tableName)
    {
        // 初始化
        this.table = table;
        ...
        String[] colArray = { "欄位", "書本編號", "書名", "ISBN", "類別", "出版社", "單位", "定價", "數量", "儲位" };
            ...
            colComboBox.addItemListener((ItemEvent item) ->
            {
                ...
                switch (str) // ComboBox欄位被選取時設定相對應欄位名稱
                {
                    ...
                    case "類別":
                        ...
                        break;
                    case "出版社":
                        colComboBox.setName("b_pub");
                        break;
                    case "單位":
                        colComboBox.setName("b_unit");
                        break;
                    case "定價":
                        colComboBox.setName("b_price");
                        break;
                    case "數量":
                        colComboBox.setName("b_qty");
                        break;
                    case "儲位":
                        colComboBox.setName("b_pos");
                        break;
